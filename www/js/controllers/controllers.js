...
cbbApp.controller('stateController',
    function($scope, $rootScope, $location, $http, $modal,
        ...
        $scope.updateNewEarnedBadge = function () {
            return participantService.earnedNewBadge;
        };

        $scope.getLoginStatus = function () {
            return participantService.globalLoginStatus;
        };
            ...
            $http.get('http://cbb.ucdenver.edu:3000/badgeInfo/' + userID).
                success(function (data, status, headers, config) {
                    ...
                    if ($scope.appsData.status == "success") {
                        var badge = $scope.appsData.badgeToEarn-1;
    ...
    function ($scope, $window, $http, $location, participantService) {
        ...
        $scope.getGoalsInfo = function () {
            ...
            //window.alert('goals from service are: ' + participantService.getGoalsDays()
    ...
    function ($scope, $window, $http, participantService) {
        ...
        function init() {
            ...
            $scope.earnedNewBadge = participantService.earnedNewBadge;
        ...
        $scope.initialize = function() {
            ...
            $scope.pointsToEarnNextBadge = number - $scope.totalPoints;
                ...
                $http({method: 'POST',
                    ...
                    success(function(data, status, headers, config) {
                        ...
                        if (points >= $scope.statusBadge[$scope.nextBadgeToEarn][0]) {
                            ...
                            $scope.statusBadge[$scope.nextBadgeToEarn][1] = true;
                            participantService.statusBadge[$scope.nextBadgeToEarn][1] = true;

                            window.alert('Congratulations! You just earned a new badge.');

                            participantService.setNextBadgeToEarn($scope.nextBadgeToEarn+1);
                            participantService.earnedNewBadge = true;
